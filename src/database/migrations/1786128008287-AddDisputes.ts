...
export class AddDisputes1786128008287 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "disputes" ("id" uuid NOT NULL, "payment_id" character varying NOT NULL, "merchant_id" character varying NOT NULL, "psp_provider" character varying NOT NULL, "psp_dispute_id" character varying NOT NULL, "amount_minor_units" bigint NOT NULL, "currency_code" character varying(3) NOT NULL, "reason" character varying, "status" character varying NOT NULL DEFAULT 'NEEDS_RESPONSE', "respond_by" TIMESTAMP WITH TIME ZONE NOT NULL, "evidence" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3c97580d01c1a4b0b345c42a107" PRIMARY KEY ("id"))`,
    );
