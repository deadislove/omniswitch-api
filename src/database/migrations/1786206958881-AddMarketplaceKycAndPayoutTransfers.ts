...
export class AddMarketplaceKycAndPayoutTransfers1786206958881 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "payouts" ADD "transfer_status" character varying NOT NULL DEFAULT 'NOT_INITIATED'`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "merchants" ADD "kyc_status" character varying NOT NULL DEFAULT 'NOT_STARTED'`,
    );
